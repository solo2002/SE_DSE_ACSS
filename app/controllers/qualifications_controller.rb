...
def create
  @competition = Competition.find params[:competition_id]
	...
	if params[:first_round] != nil
      ...
      params[:contestant_number].keys.each do |individual_part_id|
        if params[:contestant_number][individual_part_id.to_s] != ""
          if(unique.has_key? params[:contestant_number][individual_part_id])
          ...
          unique[params[:contestant_number][individual_part_id]] = 1;
          if( (!params[:selected_participants].has_key? individual_part_id.to_s))
			...
			params[:selected_participants].keys.each do |individual_part_id|
				qual_params[:participant_number] = params[:contestant_number][individual_part_id.to_s]
